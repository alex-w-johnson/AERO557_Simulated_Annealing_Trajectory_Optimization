...
%bodies is calculated using the AERO557planetcoe_and_sv() function
% =========================================================================
%   Inputs:
%     x = solution input column vector, whose elements are:
%         depDate ={num} orbit transfer departure Julian Date
%         arrDate ={num} orbit transfer arrival Julian Date
...
%         .soi ={num} Hill sphere radius of departure body's sphere of
%           influence [km]
%     arrBodyStruct = struct containing departure body information:
%         .ID ={char} string of arrival body name for planetEphemeris() 
%           data, e.g. 'Earth','Mars','Jupiter' (see Aerospace Toolbox
%           documentation)
%         .mu ={num} gravitational parameter of arrival body [km^3/s^2]
%         .soi ={num} Hill sphere radius of arrival body's sphere of 
%           influence [km]
%     mu_cent ={num} gravitational parameter of central body [km^3/s^2]
% =========================================================================
% Outputs:
%   f ={num} function evaluated to be minimized, equal to the sum of
%   departure and arrival delta-V for the entire orbit transfer
% =========================================================================
